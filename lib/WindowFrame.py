...
class QUnFrameWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.setSurface() # 设置无边框半透明圆角的窗口外观与初始大小
    ...
    def initLayout(self):
        ...
        self._MainLayout.addWidget(self.ContentSpace)
        self._MainLayout.setStretch(0, 1)
        self._MainLayout.setStretch(1, 10)
    ...
    def setMinButton(self, bool):
        ...
        if bool == True:
            ...
            self._MinimumButton.setObjectName("MinButton") # 设置按钮的ObjectName以在qss样式表内定义不同的按钮样式
    ...
    def setMaxButton(self, bool):
        self._MaximumButton = QTitleButton(b'\xef\x80\xb1'.decode("utf-8"), self)
        self._MaximumButton.setObjectName("MaxButton") # 设置按钮的ObjectName以在qss样式表内定义不同的按钮样式
